...
const contactItems = [
  {
    ...
    icon: (
      <svg width="57" height="57" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    icon: (
      <svg width="57" height="57" viewBox="0 0 24 24" fill="currentColor">
